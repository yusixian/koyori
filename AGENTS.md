...
- 日常发版以受保护流水线对候选安装包的安装、启动、核心流程及版本验收为准；更新机制、签名模式或数据迁移改变时，另做隔离的升级与数据保留检查。首次发布注明升级不适用。

## 发布与开源

- 用户要求完整发版并同步文档站时，使用项目 Skill [`$oneshot`](.agents/skills/oneshot/SKILL.md)；只要求更新说明时按请求范围处理。
