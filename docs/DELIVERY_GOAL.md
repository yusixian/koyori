...
分支 `feat/preview-updates` 已集成 `0.1.0-alpha.1` 的更新界面、打包与发布清单代码，以及项目级 Skills 部署/撤销、本地操作卡和“我的服务”入口。项目部署的 CLI 入口正在独立 Lody 会话中补齐。未签名候选仅支持明确标注的手动安装，签名与公证暂缓。没有发布真实资产前，网站继续显示未发布；配置步骤见 [macOS 签名与发布](release-signing.md)。
