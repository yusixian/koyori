...
> 2026-09-23；本地自配模型文字 Agent 与单 Skill 按需讨论已进入开发版；讨论切片的交付证据见 [PR #5](https://github.com/yusixian/koyori/pull/5)。当前功能分支新增本地 Skill 偏好操作卡与项目级受管部署/撤销。个人 Bot 远端接入、通用工具操作卡和语音仍是候选阶段。本文不复制 Bot 代码、修改服务器或部署任何服务。
