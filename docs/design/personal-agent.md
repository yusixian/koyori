...
> 2026-09-26；本地自配模型文字 Agent 与单 Skill 按需讨论已进入开发版；原讨论切片的交付证据见 [PR #5](https://github.com/yusixian/koyori/pull/5)。#28 开发分支新增从摘要预览返回使用证据的入口，尚非公开 Preview 的发布证据。个人 Bot 远端接入、通用工具操作卡和语音仍是候选阶段。本文不复制 Bot 代码、修改服务器或部署任何服务。
